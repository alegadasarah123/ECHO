...
export default function SOSEmergencyScreen({ onBack }: SOSEmergencyProps) {
  ...
  const [currentLocation, setCurrentLocation] = useState("123 Main Street, San Jose - (Lat: 14.5995, Long: 120.9842)")
  ...
  const handleSendSOS = () => {
    ...
    // Auto close modal after 3 seconds (but don't navigate back)
    setTimeout(() => {
