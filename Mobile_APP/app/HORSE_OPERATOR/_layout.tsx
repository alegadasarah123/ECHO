...
export default function OperatorLayout() {
  return (
    ...
    >
      ...
      <Stack.Screen name="Iicalendar" options={{ title: 'Calendar' }} />
      <Stack.Screen name="helpsupp" options={{ title: 'Help & Support' }} />
      <Stack.Screen name="Hfeed" options={{ title: 'Horse Feed' }} />
      <Stack.Screen name="Hfeeding" options={{ title: 'Horse Feeding Log' }} />
      ...
      <Stack.Screen name="horsedeathimp" options={{ title: 'Horse Death Report' }} />
      <Stack.Screen name="horsehanding" options={{ title: 'Horse Handling' }} />
