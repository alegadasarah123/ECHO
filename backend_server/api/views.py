...
#------------------------------------------------------- PSGC PROXY AND FALLBACK --------------------------------------------------------------------------------------
@api_view(['GET'])
def psgc_proxy(request):
    """Proxy view to fetch PSGC data and avoid CORS issues"""
    
    PSGC_BASE_URL = "https://psgc.rootscratch.com"
    endpoint = request.GET.get('endpoint', '')
    
    if not endpoint:
        return JsonResponse({'error': 'Endpoint parameter is required'}, status=status.HTTP_400_BAD_REQUEST)
    
    try:
        # Validate endpoint to prevent security issues
        allowed_endpoints = ['/provinces', '/cities-municipalities', '/barangays']
        if not any(endpoint.startswith(allowed) for allowed in allowed_endpoints):
            return JsonResponse({'error': 'Invalid endpoint'}, status=status.HTTP_400_BAD_REQUEST)
        
        url = f"{PSGC_BASE_URL}{endpoint}"
        ...
        return JsonResponse({'error': f'Failed to fetch data: {str(e)}'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    except Exception as e:
        return JsonResponse({'error': f'Unexpected error: {str(e)}'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)

# Fallback data - PROVINCES only (no regions)
FALLBACK_PROVINCES = [
    {"name": "Abra", "code": "140100000"},
    {"name": "Agusan del Norte", "code": "160200000"},
    {"name": "Agusan del Sur", "code": "160300000"},
    {"name": "Aklan", "code": "060400000"},
    {"name": "Albay", "code": "050500000"},
    {"name": "Antique", "code": "060600000"},
    {"name": "Apayao", "code": "148100000"},
    {"name": "Aurora", "code": "037000000"},
    ...
    {"name": "Biliran", "code": "087800000"},
    {"name": "Bohol", "code": "071200000"},
    {"name": "Bukidnon", "code": "101300000"},
    {"name": "Bulacan", "code": "031400000"},
    {"name": "Cagayan", "code": "021500000"},
    {"name": "Camarines Norte", "code": "051600000"},
    {"name": "Camarines Sur", "code": "051700000"},
    {"name": "Camiguin", "code": "101800000"},
    {"name": "Capiz", "code": "061900000"},
    {"name": "Catanduanes", "code": "052000000"},
    ...
    {"name": "Eastern Samar", "code": "082600000"},
    {"name": "Guimaras", "code": "067900000"},
    {"name": "Ifugao", "code": "142700000"},
    {"name": "Ilocos Norte", "code": "012800000"},
    {"name": "Ilocos Sur", "code": "012900000"},
    {"name": "Iloilo", "code": "063000000"},
    {"name": "Isabela", "code": "023100000"},
    {"name": "Kalinga", "code": "143200000"},
    {"name": "La Union", "code": "013300000"},
    {"name": "Laguna", "code": "043400000"},
    {"name": "Lanao del Norte", "code": "153500000"},
    {"name": "Lanao del Sur", "code": "153600000"},
    {"name": "Leyte", "code": "083700000"},
    {"name": "Maguindanao del Norte", "code": "153800000"},
    {"name": "Maguindanao del Sur", "code": "153900000"},
    {"name": "Marinduque", "code": "174000000"},
    {"name": "Masbate", "code": "054100000"},
    {"name": "Metro Manila", "code": "133900000"},
    {"name": "Misamis Occidental", "code": "104200000"},
    {"name": "Misamis Oriental", "code": "104300000"},
    {"name": "Mountain Province", "code": "144400000"},
    {"name": "Negros Occidental", "code": "064500000"},
    {"name": "Negros Oriental", "code": "074600000"},
    {"name": "Northern Samar", "code": "084800000"},
    {"name": "Nueva Ecija", "code": "034900000"},
    {"name": "Nueva Vizcaya", "code": "025000000"},
    {"name": "Occidental Mindoro", "code": "175100000"},
    {"name": "Oriental Mindoro", "code": "175200000"},
    {"name": "Palawan", "code": "175300000"},
    {"name": "Pampanga", "code": "035400000"},
    {"name": "Pangasinan", "code": "015500000"},
    {"name": "Quezon", "code": "045600000"},
    {"name": "Quirino", "code": "025700000"},
    {"name": "Rizal", "code": "045800000"},
    {"name": "Romblon", "code": "175900000"},
    {"name": "Samar", "code": "086000000"},
    {"name": "Sarangani", "code": "128300000"},
    {"name": "Siquijor", "code": "076100000"},
    {"name": "Sorsogon", "code": "056200000"},
    {"name": "South Cotabato", "code": "126300000"},
    {"name": "Southern Leyte", "code": "086400000"},
...
@api_view(['GET'])
def psgc_fallback(request):
    """Fallback view that returns cached PSGC data"""
    
    endpoint = request.GET.get('endpoint', '')
    
    if endpoint == '/provinces':
        return JsonResponse(FALLBACK_PROVINCES, safe=False)
    else:
