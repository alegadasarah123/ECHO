...
import "./DvmfAnnouncement.css"; // Import the new CSS file
...
function DvmfAnnouncement() {
    ...
    setNotifications([
      {
        ...
        message: "Check out the latest updates from DVMF.",
        type: "info",
  ...
  const confirmLogout = () => {
    ...
    navigate("/DvmfLogin") // Assuming this is your login route
    closeLogoutModal()
  }
      ...
      <div className={`sidebar ${isSidebarExpanded ? "open" : ""}`} id="sidebar">
        ...
        <nav className="nav-menu">
          {[
            ...
            { name: "Announcements", iconClass: "fas fa-bullhorn", path: "/DvmfAnnouncement", active: true },
                      ...
                      <div className="post-item" key={post.id}>
                        <div className="post-header">
                          <div className="post-avatar">
                            <img src="/images/LOGON.png" alt="DVMF Logo" />
                          </div>
                        ...
                        {post.isCommentsOpen && (
                          <div className="comment-section active" id={`comment-section-${post.id}`}>
                            <div className="comment-form">
                              <div className="comment-avatar">
                                <img src="/images/LOGON.png" alt="Your avatar" />
                              </div>
