    ...
    <div style={styles.conversationList}>
      ...
      <div style={styles.conversationsContainer}>
        {conversations.map((conv) => (
          <div key={conv.id} onClick={() => setSelectedConversation(conv)} style={styles.conversationItem}>
            ...
            <div style={{ maxWidth: "60%" }}>
              ...
              <div
                style={{
                  ...
                  paddingLeft: message.isOwn ? "0" : "4px",
                  paddingRight: message.isOwn ? "4px" : "0",
                }}
              >
                {message.timestamp}
              </div>
        ...
        <div style={{ flex: 1, display: "flex" }}>
          ...
          <div style={{ flex: 1 }}>
            {selectedConversation ? (
              ...
              <div style={{ padding: "20px", color: "#6b7280" }}>Select a conversation</div>
            )}
          </div>
        </div>
      ) : selectedConversation ? (
...
const styles = {
  ...
  floatingButton: {
    ...
    height: "64px",
    borderRadius: "9999px",
    background: "linear-gradient(to bottom right, #0F3D5A, #0F3D5A)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    color: "#fff",
  ...
  chatBoxHeader: {
    ...
    padding: "16px",
    borderBottom: "1px solid #e5e7eb",
    background: "linear-gradient(to right, #0F3D5A, #0F3D5A",
    color: "#fff",
  },
