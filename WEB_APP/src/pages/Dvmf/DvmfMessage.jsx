    ...
    <>
      <div className="fixed inset-0 z-1001 flex items-center justify-center backdrop-blur-sm p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] flex flex-col">
          <div className="relative bg-[#0F3D5A] pt-16 pb-6 flex-shrink-0">
            <button
              onClick={onClose}
            ...
            <div className="flex justify-center">
              <div 
                ...
                className="w-24 h-24 bg-[#0F3D5A] rounded-full border-4 border-white flex items-center justify-center text-white text-2xl font-bold shadow-lg cursor-pointer hover:scale-105 transition-transform duration-200 overflow-hidden"
              >
            ...
            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  <User className="w-5 h-5 text-[#0F3D5A] mt-0.5 flex-shrink-0" />
                ...
                {/* Phone */}
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  <Phone className="w-5 h-5 text-[#0F3D5A] mt-0.5 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                ...
                {/* Age and Gender */}
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  <Calendar className="w-5 h-5 text-[#0F3D5A] mt-0.5 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                ...
                {/* Address */}
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  <MapPin className="w-5 h-5 text-[#0F3D5A] mt-0.5 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                ...
                {profileData.vet_org && (
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    <Building className="w-5 h-5 text-[#0F3D5A] mt-0.5 flex-shrink-0" />
                    <div className="flex-1 min-w-0">
          ...
          <div className="relative max-w-2xl w-full max-h-full">
            ...
            <div className="bg-white rounded-lg overflow-hidden max-w-sm w-full mx-auto">
              {profileData.vet_profile_photo ? (
                ...
                <div className="w-full h-96 bg-[#0F3D5A] flex items-center justify-center">
...
const CtuVetProfileModal = ({ user, profileData, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-1001 flex items-center justify-center backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] flex flex-col">
        <div className="relative bg-[#0F3D5A] pt-15 pb-4 flex-shrink-0">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-all z-10 shadow-lg"
          >
    ...
    return (
      <div className="fixed inset-0 z-1001 flex items-center justify-center backdrop-blur-sm p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#0F3D5A] mx-auto"></div>
...
const Avatar = ({ user, size = "md", onClick, clickable = true, inChatView = false }) => {
  ...
  const avatarContent = predefinedAvatar ? (
    ...
    <div
      className={`${sizeClasses[size]} bg-[#0F3D5A] rounded-full flex items-center justify-center text-white font-semibold ${
        shouldBeClickable ? "cursor-pointer hover:opacity-80 transition-opacity" : ""
      }`}
      onClick={shouldBeClickable ? onClick : undefined}
    >
      ...
      <>
        <div className="fixed bottom-6 right-6 z-50">
          <button
            ...
            className="relative w-16 h-16 bg-[#0F3D5A] hover:bg-[#0c2f47] text-white rounded-full shadow-xl hover:shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1"
          >
