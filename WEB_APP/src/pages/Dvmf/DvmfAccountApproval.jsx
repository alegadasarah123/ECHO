...
import "./DvmfAccountApproval.css"; // Import the new CSS file
  ...
  return (
    <div className="bodyWrapper">
      <div className="sidebar" id="sidebar">
        ...
        <nav className="nav-menu">
          {[
            ...
            { name: "Account Approval", iconClass: "fas fa-user-check", path: "/DvmfAccountApproval", active: true },
      ...
      <div className="chat-widget">
        <button className="chat-button" onClick={() => navigate("/DvmfMessage")}>
