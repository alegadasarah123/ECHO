...
const DvmfAnnouncement = () => {
  ...
  // Add user state (you might want to get this from your auth system)
  const [currentUser, setCurrentUser] = useState({
    id: "user-1", // Replace with actual user ID from your auth system
    name: "You",
  ...
  `http://localhost:8000/api/dvmf/get_comments/?post_id=${postId}`,
  { credentials: "include" }
);
      ...
      if (response.ok && result.data) {
        ...
        const postsWithComments = await Promise.all(
          result.data.map(async (announcement) => {
            ...
            const isCTUAnnouncement =
              title === "ctu announcement" ||
              title.includes("ctu") ||
              title === "ctu vetmed"
  ...
  try {
    const res = await fetch(
      `http://localhost:8000/api/dvmf/add_comment/`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  overflow: hidden;
  border: 2px solid #0F3D5Ac;
  flex-shrink: 0;
  background-color: white; /* keeps it clean behind the image */
}

.profile-logo img {
  width: 175%;          /* zoom in to fill the circle */
  height: 175%;
        ...
        <div className="content-areas">
          <div className="profile-section">
            <div className="profile-logo">
              <img src="/Images/dvmf.png" alt="CTU Logo" className="logo" />
            </div>
            ...
            <div className="profile-details">
              ...
              <div className="detail-item">
                ...
                <span>Xiamen St., Mabolo, Cebu City</span>
              </div>
                        ...
                        <div style={{ position: "relative" }}>
                          ...
                          {showDropdown[post.id] && (
                            ...
                            >
                              ...
                              {/* Edit Post - Only show if not already editing */}
