  ...
  const fetchProfileData = async () => {
    ...
    try {
      ...
      if (user.role === 'Veterinarian') {
        endpoint = `http://localhost:8000/api/ctu_vetmed/vet_profile_by_id/${user.id}/`;
      } else if (user.role === 'Horse Operator') {
        endpoint = `http://localhost:8000/api/ctu_vetmed/horse_operator_profile_by_id/${user.id}/`;
      } else if (user.role === 'Kutsero') {
        endpoint = `http://localhost:8000/api/ctu_vetmed/kutsero_profile_by_id/${user.id}/`;
      } else if (user.role === 'Ctu-Vetmed' || user.role === 'Ctu-Admin') {
        endpoint = `http://localhost:8000/api/ctu_vetmed/ctu_vet_profile_by_id/${user.id}/`;
      } else if (user.role === 'Dvmf' || user.role === 'Dvmf-Admin') {
        endpoint = `http://localhost:8000/api/ctu_vetmed/dvmf_user_profile_by_id/${user.id}/`;
      }
