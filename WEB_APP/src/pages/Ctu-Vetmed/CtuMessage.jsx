...
const Avatar = ({ user, size = "md" }) => {
  ...
  return (
    <div className={`${sizeClasses[size]} bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d] rounded-full flex items-center justify-center text-white font-semibold`}>
              ...
              >
                <div
                  className={`px-4 py-2 rounded-2xl text-sm ${
                    message.isOwn
                      ? "bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d] text-white rounded-br-md"
  ...
  return (
    ...
    >
      ...
      {conversation.unread > 0 && (
        <div className="w-5 h-5 bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d] text-white rounded-full flex items-center justify-center text-xs font-medium">
          {conversation.unread}
        </div>
      )}
    </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${
              newMessage.trim()
                ? "bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d] hover:from-[#7f1d1d] hover:to-[#991b1b] text-white"
    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="relative w-16 h-16 bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d] hover:from-[#7f1d1d] hover:to-[#991b1b] text-white rounded-full shadow-xl hover:shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1"
        >
