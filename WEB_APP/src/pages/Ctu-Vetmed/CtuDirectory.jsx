    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div ref={sidebarRef} className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
        ...
        <nav className="nav-menu">
          {[
            { name: "Dashboard", iconClass: "fas fa-th-large", page: "dashboard", route: "/CtufDashboard" },
            {
            ...
            { name: "Access Requests", iconClass: "fas fa-file-alt", page: "requests", route: "/CtuAccessRequest" },
            { name: "Horse Records", iconClass: "fas fa-clipboard-list", page: "records", route: "/CtuHorseRecord" },
            { name: "Health Reports", iconClass: "fas fa-chart-bar", page: "reports", route: "/CtuHealthReport" },
            { name: "Announcements", iconClass: "fas fa-bullhorn", page: "announcements", route: "/CtuAnnouncement" },
            { name: "Directory", iconClass: "fas fa-folder", page: "directory", route: "/CtuDirectory" },
            { name: "Settings", iconClass: "fas fa-cog", page: "settings", route: "/CtuSettings" },
          ].map((item) => (
            <a
              key={item.page}
              href="#"
